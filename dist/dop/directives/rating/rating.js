define([
    ...
    app.directive('dopRating', ["translationService", "$mdToast", "$translate", "serverCallService", "authenticatedUserService", function(translationService, $mdToast, $translate, serverCallService, authenticatedUserService) {
        return {
            scope: {
                material: '=',
                portfolio: '=',
            ...
            controller: ["$scope", "$mdToast", "$translate", "serverCallService", "authenticatedUserService", function($scope, $mdToast, $translate, serverCallService, authenticatedUserService) {
