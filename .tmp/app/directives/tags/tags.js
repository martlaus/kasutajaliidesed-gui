define([
    ...
    angularAMD.directive('dopTags',['translationService', '$mdToast', '$translate', 'serverCallService', 'searchService', 'authenticatedUserService', '$location', '$rootScope', '$mdDialog', 'storageService',
        ...
        return {
            ...
            controller: ["$scope", "$mdToast", "$translate", "serverCallService", "searchService", "authenticatedUserService", "$location", function ($scope, $mdToast, $translate, serverCallService, searchService, authenticatedUserService, $location) {
                var allUpVoteForms;
